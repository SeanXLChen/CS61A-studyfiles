...
def roll_dice(num_rolls, dice=six_sided):
    ...
    #check if any roll is one, if true return 1
    if has_one:
        return 1
    else:
        return score_sum
...
def swine_align(player_score, opponent_score):
    ...
    while (player_score % i != 0 or opponent_score % i != 0):
        i -= 1
    if i < 10:
        return False
    else:
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    "*** YOUR CODE HERE ***"
    #start
    def isgameover(score0, score1):
        if score0 >= goal or score1 >= goal:
            return True
        return False

    turn = 0
    while(not isgameover(score0, score1)):
        if who == 0:
            score0 += take_turn(strategy0(score0, score1), score1, dice)
            #each turn call commentary function
            say = say(score0, score1)
            while(extra_turn(score0, score1) and (not isgameover(score0, score1))):
                score0 += take_turn(strategy0(score0, score1), score1, dice)
                #each turn call commentary function
                say = say(score0, score1)
        if who == 1:
            ...
            #each turn call commentary function
            say = say(score0, score1)
            while(extra_turn(score1, score0) and (not isgameover(score0, score1))):
                score1 += take_turn(strategy1(score1, score0), score0, dice)
                #each turn call commentary function
                say = say(score0, score1)
        #change turn after one player's turn
        who = other(who)
    # END PROBLEM 5
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0:
            #calculate this turn's high
            thisturn_high = score0 - last_score
            #if new high, update running_high
            if running_high < thisturn_high:
                print("{0} point(s)! The most yet for Player 0".format(thisturn_high))
                return announce_highest(0, score0, thisturn_high)
            return announce_highest(0, score0, running_high)
        else:
            #calculate this turn's high
            thisturn_high = score1 - last_score
            #if new high, update running_high
            if running_high < thisturn_high:
                print("{0} point(s)! The most yet for Player 1".format(thisturn_high))
                return announce_highest(1, score1, thisturn_high)
...
def make_averaged(original_function, trials_count=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    assert trials_count > 0, 'trails must be a positive number'
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    high_value = 0
    for i in range(1,11):
        thisturn_value = averaged_roll_dice(i, dice)
        if thisturn_value > high_value:
            high_value, high_turn = thisturn_value, i
    return high_turn
    # END PROBLEM 9
